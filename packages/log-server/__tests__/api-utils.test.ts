...
type TestApi = {
  ...
  '/resources': {
    ...
    post: {
      ...
      responses: {
        404: { content: { 'res-post-404-content-type': 'res-post-404-body' } };
        200: { content: { 'res-post-200-content-type': 'res-post-200-body' } };
      };
    };
    get: {
      ...
      requestBody?: never;
      responses: {
        404: { content: { 'res-get-404-content-type': 'res-get-404-body' } };
        200: { content: { 'res-get-200-content-type': 'res-get-200-body' } };
      };
    };
  };
};
...
test('ApiResponseContent', () => {
  type Actual = ApiResponseContent<TestApi, '/resources', 'get'>;
  type Expected =
    | {
        contentType: 'res-get-404-content-type';
        body: 'res-get-404-body';
        status: 404;
      }
    | {
        contentType: 'res-get-200-content-type';
        body: 'res-get-200-body';
        status: 200;
      };
  expectTypeOf<Actual>().toEqualTypeOf<Expected>();
});
