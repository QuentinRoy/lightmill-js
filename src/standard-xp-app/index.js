 ...
 * @abstract
 */
export function StandardXpAppBase(node) {
 ...
 * @type {Object}
 */
export class StandardXpApp extends StandardXpAppBase {
  /**
   * @param  {HTMLElement} node          The node where to mount the applicatin.
